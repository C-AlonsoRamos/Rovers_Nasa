  ...
  return (
    <footer>
      ...
      <div className='footer-social'>
        <a href="https://github.com/C-AlonsoRamos" target="_blank" ><img src="https://res.cloudinary.com/dy4mossqz/image/upload/v1683577415/img/pngimg.com_-_github_PNG83_vrtwxu.png" alt="logo GitHub" /></a>
